                ...
                onPressSave: function (oEvent) {
                    ...
                    if (array.length > 0) {
                        for (var i = 0; i < array.length; i++) {
                            ...
                            var closingBalance = parseFloat(array[i].PriorYearAdjustments + array[i].extraordinaryTransactions + array[i].CurrentYearAccrual + array[i].CurrentYearUtilization + array[i].otherAdjustments);
