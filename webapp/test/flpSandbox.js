		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Tax Provisioning landing page",
									"targetURL": "#taxprovisioningcomputations-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"taxprovisioningcomputations-display": {
								"semanticObject": "taxprovisioningcomputations",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tax.provisioning.computations",
									"url": sap.ui.require.toUrl("tax/provisioning/computations")
								}
							}
						}
					}
